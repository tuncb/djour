...
- Add unit tests
- If the behavior change can be checked using file output add a test in one or more of the end2end tests under fixtures\synthetic folder.
...
Note that DJOUR_ROOT environment variable might be defined already in this computer, so make sure tests work independently of this definition.
